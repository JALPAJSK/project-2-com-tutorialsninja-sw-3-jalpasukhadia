...
public class LaptopsAndNoteBooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-firstname']"), "Krish");
        sendTextToElement(By.xpath("//input[@id='input-payment-lastname']"), "Sukha");
        sendTextToElement(By.xpath("//input[@id='input-payment-email']"), "krish22@gmail.com");
        sendTextToElement(By.xpath("//input[@id='input-payment-telephone']"), "07123456911");
        sendTextToElement(By.xpath("//input[@id='input-payment-address-1']"), "50 Brent Road");
        sendTextToElement(By.xpath("//input[@id='input-payment-city']"), "London");
        sendTextToElement(By.xpath("//input[@id='input-payment-postcode']"), "HA0 1AB");
        selectByValueFromDropDown(By.xpath("//select[@id='input-payment-country']"), "256");
        selectByValueFromDropDown(By.xpath("//select[@id='input-payment-zone']"), "3433");
